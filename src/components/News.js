...
export default function News(props) {
  ...
  return (
    <div>
      <h1 className="text-center mt-3 mb-2" style={{ color: props.mode==='dark' ? 'white' : 'black' }}>
      ...
      <div className="row cardbox" style={{ backgroundColor: props.mode==='dark' ? '#171717' : 'white' }}>
        {article.map((element) => {
          return (
